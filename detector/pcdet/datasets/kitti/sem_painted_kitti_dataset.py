...
class PaintedKittiDataset(DatasetTemplate):
    ...
    ####################### If there is a change on directories, please modify below ###############################
    ...
    def get_painted_lidar(self, idx):
        lidar_file = self.root_split_path / 'painted_lidars' / ('%s.npy' % idx)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        assert os.path.isdir(ROOT_DIR), "Inappropriate directory for KITTI dataset : {}".format(ROOT_DIR)
        create_kitti_infos(
