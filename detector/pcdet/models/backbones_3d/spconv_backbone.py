...
def post_act_block(in_channels, out_channels, kernel_size, indice_key=None, stride=1, padding=0,
    ...
    if conv_type == 'subm':
        ...
        conv = spconv.pytorch.SparseConv3d(in_channels, out_channels, kernel_size, stride=stride, padding=padding,
                                   bias=False, indice_key=indice_key)
    elif conv_type == 'inverseconv':
        conv = spconv.pytorch.SparseInverseConv3d(in_channels, out_channels, kernel_size, indice_key=indice_key, bias=False)
    else:
...
class VoxelBackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv_out = spconv.pytorch.SparseSequential(
            # [200, 150, 5] -> [200, 150, 2]
            spconv.pytorch.SparseConv3d(64, 128, (3, 1, 1), stride=(2, 1, 1), padding=last_pad,
    ...
    def forward(self, batch_dict):
        ...
        input_sp_tensor = spconv.pytorch.SparseConvTensor(
...
class VoxelResBackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv_out = spconv.pytorch.SparseSequential(
            # [200, 150, 5] -> [200, 150, 2]
            spconv.pytorch.SparseConv3d(128, 128, (3, 1, 1), stride=(2, 1, 1), padding=last_pad,
                                bias=False, indice_key='spconv_down2'),
            norm_fn(128),
            nn.ReLU(),
        )
